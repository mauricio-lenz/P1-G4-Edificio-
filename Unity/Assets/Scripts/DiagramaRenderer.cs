...
namespace EdificioUnity
{
    ...
    public class DiagramaRenderer : MonoBehaviour
    {
        ...
        public static DiagramaRenderer Create(Transform parent)
        {
            ...
            dr._rotulo = bar.AddComponent<TextMesh>();
            dr._rotulo.characterSize = 0.4f;
            dr._rotulo.fontSize = 48;
            dr._rotulo.anchor = TextAnchor.MiddleLeft;
        ...
        public void Dibujar(ElementoView el, TipoDiagrama tipo, string combo)
        {
            ...
            _rotulo.text = $"{Etiqueta(tipo)} = {valor:0.#} [{combo}]";
            _rotulo.transform.position = fin + dir * 2f;
        }
